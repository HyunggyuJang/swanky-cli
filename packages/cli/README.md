...
running command...
$ swanky (--version|-V|-v)
@arthswap/swanky-cli/0.0.7-alpha.0 darwin-arm64 node-v18.14.2
$ swanky --help [COMMAND]
USAGE
  $ swanky COMMAND
...
...
_See code: [dist/commands/check/index.js](https://github.com/AstarNetwork/swanky-cli/blob/v0.0.7-alpha.0/dist/commands/check/index.js)_
...
_See code: [dist/commands/init/index.js](https://github.com/AstarNetwork/swanky-cli/blob/v0.0.7-alpha.0/dist/commands/init/index.js)_
